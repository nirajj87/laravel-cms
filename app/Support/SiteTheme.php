...
class SiteTheme
{
    ...
    public static function css(array $theme, array $site = []): string
    {
        ...
        $css .= '.site-grid{display:grid;grid-template-columns:repeat(var(--site-columns),minmax(0,1fr));gap:1.35rem;}';
        ...
        $css .= '@media (max-width:1024px){.site-row{grid-template-columns:repeat(2,minmax(0,1fr));}.site-span{grid-column:span var(--span-tablet)!important;}.site-grid{grid-template-columns:repeat(2,minmax(0,1fr));}.site-hero{min-height:26rem;}}';
        $css .= '@media (max-width:700px){.site-bar{flex-wrap:wrap;padding:.8rem 0;}.site-header .site-nav{display:none;width:100%;margin:0;}.site-header .site-nav.is-open{display:flex;}.site-menu-btn{margin-left:auto;} .site-row,.site-grid,.site-search{grid-template-columns:1fr;} .site-span{grid-column:span 1!important;}.site-hero{min-height:22rem;padding-top:3.25rem;}.site-card img,.site-placeholder{min-height:10rem;}}';
