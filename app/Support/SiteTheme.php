...
class SiteTheme
{
    ...
    public static function css(array $theme, array $site = []): string
    {
        ...
        $css .= '.site-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:1.35rem;justify-content:start;}';
        $css .= '.site-card{background:#fff;color:#0f172a;border:1px solid var(--site-card-border);border-radius:calc(var(--site-radius) + 6px);box-shadow:0 1px 2px rgba(15,23,42,.04), var(--site-card-shadow);overflow:hidden;display:flex;flex-direction:column;height:100%;}';
        $css .= '.site-card-media{position:relative;overflow:hidden;background:#0f172a;} .site-card-media > a{display:block;color:inherit;text-decoration:none;}';
        $css .= '.site-card img,.site-placeholder{width:100%;aspect-ratio:16/11;height:auto;object-fit:cover;display:block;background:#f5f5f4;} .site-placeholder{display:grid;place-items:center;min-height:11rem;background:linear-gradient(155deg, color-mix(in srgb, var(--site-primary) 82%, #022c22), color-mix(in srgb, var(--site-secondary) 40%, #020617) 58%, #020617);color:#fff;font-size:clamp(2rem,3.4vw,2.75rem);font-weight:700;letter-spacing:.08em;}';
        $css .= '.site-card .site-card-body{padding:1.2rem 1.25rem 1.35rem;display:flex;flex-direction:column;gap:.5rem;flex:1;}';
        $css .= '.site-card h2{font-size:1.15rem;line-height:1.28;margin:0;letter-spacing:-.02em;} .site-card h2 a{color:inherit;text-decoration:none;} .site-card h2 a:hover{color:var(--site-primary);}';
        $css .= '.site-card-excerpt{margin:0;color:#64748b;font-size:.94rem;line-height:1.5;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}';
        $css .= '.site-kicker{font-size:.68rem;font-weight:700;letter-spacing:.16em;text-transform:uppercase;color:#94a3b8;margin:0;} .site-meta{display:flex;flex-wrap:wrap;align-items:center;gap:.4rem .65rem;color:#78716c;font-size:.84rem;margin-top:.15rem;} .site-meta-price{font-weight:600;color:#0f172a;} .site-meta-deal{color:var(--site-primary);font-weight:600;} .site-meta-rating{margin-left:auto;color:#57534e;}';
        $css .= '.site-btn{display:inline-flex;align-items:center;justify-content:center;border-radius:999px;padding:.62rem 1.15rem;background:var(--site-button);color:#fff;text-decoration:none;font-weight:600;font-size:.88rem;border:1px solid var(--site-button);margin-top:auto;align-self:flex-start;}';
        ...
        $css .= '.site-hero{position:relative;isolation:isolate;overflow:hidden;display:grid;place-items:center;text-align:center;min-height:min(72vh,38rem);width:calc(100% + (var(--site-gutter) * 2));margin-inline:calc(var(--site-gutter) * -1);padding:4.75rem var(--site-gutter) 3.5rem;background:radial-gradient(1100px 460px at 12% -8%, color-mix(in srgb, var(--site-primary) 58%, transparent), transparent 62%), radial-gradient(800px 340px at 88% 12%, color-mix(in srgb, var(--site-secondary) 38%, transparent), transparent 55%), linear-gradient(165deg, color-mix(in srgb, var(--site-primary) 86%, #020617), #020617 74%);}';
        $css .= '.site-hero-canvas{position:absolute;inset:0;width:100%;height:100%;z-index:0;pointer-events:none;} .site-hero-copy{position:relative;z-index:1;width:min(100%, 54rem);}';
        $css .= '.site-hero .site-kicker{color:rgba(248,250,252,.7);} .site-hero h1{color:#f8fafc;font-size:clamp(2.35rem,5.2vw,4.4rem);line-height:1.02;letter-spacing:-.04em;margin:0;} .site-hero .site-lead{max-width:38rem;margin:1rem auto 0;color:rgba(248,250,252,.84);font-size:1.08rem;}';
        $css .= '.site-types{display:flex;justify-content:center;gap:.45rem .85rem;flex-wrap:wrap;margin-top:1.1rem;} .site-type{color:var(--site-text);text-decoration:none;font-size:.92rem;padding:.2rem .15rem;} .site-type.is-current{font-weight:700;}';
        $css .= '.site-hero a{color:#f8fafc;} .site-hero .site-type{color:rgba(248,250,252,.8);} .site-hero .site-type.is-current{color:#fff;border-bottom:2px solid rgba(255,255,255,.85);} .site-search{display:grid;grid-template-columns:1fr auto;gap:.65rem;max-width:44rem;margin:1.45rem auto 0;} .site-hero .site-input{border:0;border-radius:999px;padding:.95rem 1.2rem;box-shadow:0 18px 40px rgba(2,6,23,.18);} .site-hero .site-btn{margin-top:0;align-self:stretch;border-radius:999px;padding-inline:1.35rem;}';
        $css .= '.site-browse{display:flex;align-items:end;justify-content:space-between;gap:1rem;flex-wrap:wrap;margin:2rem 0 1.15rem;} .site-browse h2{margin:.15rem 0 0;font-size:clamp(1.45rem,2.2vw,2rem);letter-spacing:-.03em;}';
        ...
        $css .= '@media (max-width:1024px){.site-row{grid-template-columns:repeat(2,minmax(0,1fr));}.site-span{grid-column:span var(--span-tablet)!important;}.site-grid{grid-template-columns:repeat(auto-fill,minmax(min(100%,260px),1fr));}.site-hero{min-height:26rem;}}';
        $css .= '@media (max-width:700px){.site-bar{flex-wrap:wrap;padding:.8rem 0;}.site-header .site-nav{display:none;width:100%;margin:0;}.site-header .site-nav.is-open{display:flex;}.site-menu-btn{margin-left:auto;} .site-row,.site-search{grid-template-columns:1fr;}.site-grid{grid-template-columns:1fr;} .site-span{grid-column:span 1!important;}.site-hero{min-height:22rem;padding-top:3.25rem;}.site-card img,.site-placeholder{min-height:10rem;}}';
        ...
        if ($theme['image_hover']) {
            $motion .= '.site-card img,.site-placeholder{transition:transform .4s ease;} .site-card:hover img,.site-card:hover .site-placeholder{transform:scale(1.04);}';
        }
